...
import jayim.utils.ServerConfig;
import jayim.vo.UFile;
import jayim.vo.UploadFile;
...
public class FileUpload
{
    ...
    public @ResponseBody
    String uploadFile(@RequestParam(value = "file", required = false) MultipartFile file, int userId,
